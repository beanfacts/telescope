...
#ifndef GOOGLE_PROTOBUF_INCLUDED_tlib_2ftransport_2ftransport_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_tlib_2ftransport_2ftransport_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_tlib_2ftransport_2ftransport_2eproto
...
struct TableStruct_tlib_2ftransport_2ftransport_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tlib_2ftransport_2ftransport_2eproto;
class pb_accept;
...
class pb_wrapper PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_tlib_2ftransport_2ftransport_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_tlib_2ftransport_2ftransport_2eproto;
};
// -------------------------------------------------------------------
...
class pb_mr PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kScreenIndexFieldNumber = 1,
    kBufferIndexFieldNumber = 2,
    kIbvMrFieldNumber = 3,
  };
  // uint32 screen_index = 1;
  void clear_screen_index();
  ::PROTOBUF_NAMESPACE_ID::uint32 screen_index() const;
  void set_screen_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_screen_index() const;
  void _internal_set_screen_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:

  // uint32 buffer_index = 2;
  void clear_buffer_index();
  ::PROTOBUF_NAMESPACE_ID::uint32 buffer_index() const;
  void set_buffer_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_buffer_index() const;
  void _internal_set_buffer_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::uint32 screen_index_;
  ::PROTOBUF_NAMESPACE_ID::uint32 buffer_index_;
  union MrDataUnion {
    MrDataUnion() {}
    ::pb_ibv_mr* ibv_mr_;
  } mr_data_;
...
// uint32 screen_index = 1;
inline void pb_mr::clear_screen_index() {
  screen_index_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 pb_mr::_internal_screen_index() const {
  return screen_index_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 pb_mr::screen_index() const {
  // @@protoc_insertion_point(field_get:pb_mr.screen_index)
  return _internal_screen_index();
}
inline void pb_mr::_internal_set_screen_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  screen_index_ = value;
}
inline void pb_mr::set_screen_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_screen_index(value);
  // @@protoc_insertion_point(field_set:pb_mr.screen_index)
}

// uint32 buffer_index = 2;
inline void pb_mr::clear_buffer_index() {
  buffer_index_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 pb_mr::_internal_buffer_index() const {
  return buffer_index_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 pb_mr::buffer_index() const {
  // @@protoc_insertion_point(field_get:pb_mr.buffer_index)
  return _internal_buffer_index();
}
inline void pb_mr::_internal_set_buffer_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  buffer_index_ = value;
}
inline void pb_mr::set_buffer_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_buffer_index(value);
  // @@protoc_insertion_point(field_set:pb_mr.buffer_index)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_tlib_2ftransport_2ftransport_2eproto
